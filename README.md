...
## 不同运行主文件的功能:
    ...
    test_glassbar_grasp_main_tt_contact.py: 测试玻璃棒向下移动碰到漏斗壁是否及时停止; 利用视触觉传感器感知形变

    glassbar_grasp_main_tt_contact.py: 抓取玻璃棒调整姿态至倾斜向下，再向下移动触碰桌面; 利用视触觉传感器感知形变

    glassbar_grasp_main_v_contact.py: 抓取玻璃棒调整姿态至垂直向下，再向下移动触碰桌面; 利用视触觉传感器感知形变
